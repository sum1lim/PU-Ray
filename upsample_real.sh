...
for FILE in ./data/highway_test/resolution_h0.200_v0.400_occ/*; do
    ...
    pu_ray --input "$FILE" --r 4  --batch-size 2500 --patch-k 64 --query-k 8 --marching-steps 6 --model puray_train2test --output-dir highway_train2test --real-scanned --min-dist 30000 --fps
    ...
    pu_ray --input "$FILE" --r 4  --batch-size 2500 --patch-k 64 --query-k 8 --marching-steps 6 --model puray_test2test --output-dir highway_test2test --real-scanned --min-dist 30000 --fps
