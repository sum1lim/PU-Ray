...
for FILE in ./data/kitti_test/resolution_h0.200_v0.400_occ/*; do
    echo "******************** $(basename ${FILE%.*}) ********************"
    pu_ray --input "$FILE" --r 4  --batch-size 2500 --patch-k 64 --query-k 8 --marching-steps 6 --model puray_supervised --output-dir kitti_puray --real-scanned --min-dist 20000 --fps
    ...
    pu_ray --input "$FILE" --r 4  --batch-size 2500 --patch-k 64 --query-k 8 --marching-steps 6 --model puray_supervised --output-dir kitti_train2test --real-scanned --min-dist 20000 --fps
    ...
    pu_ray --input "$FILE" --r 4  --batch-size 2500 --patch-k 64 --query-k 8 --marching-steps 6 --model puray_supervised --output-dir kitti_test2test --real-scanned --min-dist 20000 --fps
    ...
    pu_ray --input "$FILE" --r 4  --batch-size 2500 --patch-k 64 --query-k 8 --marching-steps 6 --model puray_supervised --output-dir kitti_simple2test --real-scanned --min-dist 20000 --fps
    ...
    pu_ray --input "$FILE" --r 4  --batch-size 2500 --patch-k 64 --query-k 8 --marching-steps 6 --model puray_supervised --output-dir kitti_medium2test --real-scanned --min-dist 20000 --fps
    ...
    pu_ray --input "$FILE" --r 4  --batch-size 2500 --patch-k 64 --query-k 8 --marching-steps 6 --model puray_supervised --output-dir kitti_complext2test --real-scanned --min-dist 20000 --fps
