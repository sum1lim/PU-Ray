...
for FILE in ./data/kitti/*; do
    pu_ray --input "$FILE" --r 4  --patch-k 16 --query-k 32 --marching-steps 6 --model puray_supervised --output-dir kitti --real-scanned-snippet --fps
done
