...
for FILE in ./data/kitti_snippet/*; do
    pu_ray --input "$FILE" --r 4 --batch-size 1024 --patch-k 64 --query-k 8 --marching-steps 6 --model puray_supervised --output-dir kitti-snippet --real-scanned --min-dist 0 --fps --implicit-points
done
...
for FILE in ./data/kitti_test/resolution_h0.200_v0.400_occ/*; do
    echo "******************** $(basename ${FILE%.*}) ********************"
    pu_ray --input "$FILE" --r 4  --batch-size 2048 --patch-k 64 --query-k 8 --marching-steps 6 --model puray_supervised --output-dir kitti_puray --real-scanned --min-dist 15000 --fps
    ...
    pu_ray --input "$FILE" --r 4  --batch-size 2048 --patch-k 64 --query-k 8 --marching-steps 6 --model puray_train2test --output-dir kitti_train2test --real-scanned --min-dist 15000 --fps
    ...
    pu_ray --input "$FILE" --r 4  --batch-size 2048 --patch-k 64 --query-k 8 --marching-steps 6 --model puray_test2test --output-dir kitti_test2test --real-scanned --min-dist 15000 --fps
    ...
    pu_ray --input "$FILE" --r 4  --batch-size 2048 --patch-k 64 --query-k 8 --marching-steps 6 --model puray_simple2test --output-dir kitti_simple2test --real-scanned --min-dist 15000 --fps
    ...
    pu_ray --input "$FILE" --r 4  --batch-size 2048 --patch-k 64 --query-k 8 --marching-steps 6 --model puray_medium2test --output-dir kitti_medium2test --real-scanned --min-dist 15000 --fps
    ...
    pu_ray --input "$FILE" --r 4  --batch-size 2048 --patch-k 64 --query-k 8 --marching-steps 6 --model puray_complex2test --output-dir kitti_complext2test --real-scanned --min-dist 15000 --fps
...
for FILE in ./data/highway_test/resolution_h0.200_v0.400_occ/*; do
    echo "******************** $(basename ${FILE%.*}) ********************"
    pu_ray --input "$FILE" --r 4  --batch-size 2048 --patch-k 64 --query-k 8 --marching-steps 6 --model puray_supervised --output-dir highway_puray --real-scanned --min-dist 30000 --fps
    ...
    pu_ray --input "$FILE" --r 4  --batch-size 2048 --patch-k 64 --query-k 8 --marching-steps 6 --model puray_train2test --output-dir highway_train2test --real-scanned --min-dist 30000 --fps
    ...
    pu_ray --input "$FILE" --r 4  --batch-size 2048 --patch-k 64 --query-k 8 --marching-steps 6 --model puray_test2test --output-dir highway_test2test --real-scanned --min-dist 30000 --fps
    ...
    pu_ray --input "$FILE" --r 4  --batch-size 2048 --patch-k 64 --query-k 8 --marching-steps 6 --model puray_simple2test --output-dir highway_simple2test --real-scanned --min-dist 30000 --fps
    ...
    pu_ray --input "$FILE" --r 4  --batch-size 2048 --patch-k 64 --query-k 8 --marching-steps 6 --model puray_medium2test --output-dir highway_medium2test --real-scanned --min-dist 30000 --fps
    ...
    pu_ray --input "$FILE" --r 4  --batch-size 2048 --patch-k 64 --query-k 8 --marching-steps 6 --model puray_complex2test --output-dir highway_complext2test --real-scanned --min-dist 30000 --fps
